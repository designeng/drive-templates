module.exports = require('handlebars').template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <li>\n        <a class=\"index-com-news-caption\" href=\"/company/"
    + alias4(((helper = (helper = helpers.companyId || (depth0 != null ? depth0.companyId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"companyId","hash":{},"data":data}) : helper)))
    + ".html\">"
  ...
  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.brandName : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
  ...
  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.companyName : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "");
},"useData":true})
module.exports = require('handlebars').template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"main\">\n"
    ...
    + ((stack1 = container.invokePartial(partials.backroundSprite,depth0,{"name":"backroundSprite","hash":{"spriteClass":(depth0 != null ? depth0["open-page-top"] : depth0)},"data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + ((stack1 = container.invokePartial(partials.backroundSprite,depth0,{"name":"backroundSprite","hash":{"spriteClass":(depth0 != null ? depth0["open-page-bottom"] : depth0)},"data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "    "
